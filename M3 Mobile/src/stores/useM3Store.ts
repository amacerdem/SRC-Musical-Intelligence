/* -- M3 Store -- Unified Personal Musical Mind --------------------------------
 *  M3 growth IS persona evolution. Each learning session updates:
...
import type { NeuralFamily, Persona } from "../types/mind";
import { personas } from "../data/personas";
import { M3_STAGES, GENE_PARAM_BIASES } from "../data/m3-stages";
      ...
      setTier: (tier) => {
        ...
        if (wasFrozen && !isFree) {
          newMilestones.push({
            type: "insight",
            timestamp: now,
            detail: `Upgraded to ${tier} -- M3 unfrozen`,
          });
        }
