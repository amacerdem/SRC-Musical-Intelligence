...
import { G, Path, Ellipse, Line } from "react-native-svg";
...
const AngularBody = ({ color }: { color: string }) => (
  <G>
    <Path d="M82 124 Q78 126 74 160 L72 210 Q86 218 100 220 Q114 218 128 210 L126 160 Q122 126 118 124 Z" fill="#1a1a2e" />
...
const GeometricBody = ({ color }: { color: string }) => (
  <G>
    <Path d="M80 124 L76 160 L76 210 Q88 218 100 220 Q112 218 124 210 L124 160 L120 124 Z" fill="#1a1a2e" />
...
const FluidBody = ({ color }: { color: string }) => (
  <G>
    <Path d="M80 124 Q76 128 74 160 L72 210 Q86 220 100 222 Q114 220 128 210 L126 160 Q122 128 118 124 Z" fill="#1a1a2e" />
...
const RoundBody = ({ color }: { color: string }) => (
  <G>
    <Path d="M78 124 Q74 130 72 160 L72 210 Q86 220 100 222 Q114 220 128 210 L128 160 Q126 130 122 124 Z" fill="#1a1a2e" />
...
const AthleticBody = ({ color }: { color: string }) => (
  <G>
    <Path d="M76 124 Q70 128 68 160 L70 210 Q86 222 100 224 Q114 222 130 210 L132 160 Q130 128 124 124 Z" fill="#1a1a2e" />
