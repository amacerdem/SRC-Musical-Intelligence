...
export function MindChat() {
  ...
  // Hide on immersive pages, dashboard, and lab (chat is embedded there)
  const hidden = location.pathname === "/live" || location.pathname === "/my-mind" || location.pathname === "/lab" || location.pathname === "/listen";
