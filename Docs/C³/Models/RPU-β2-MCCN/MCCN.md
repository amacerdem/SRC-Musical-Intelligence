...
### 2.1 Information Flow Architecture (EAR → BRAIN → MCCN)
...
MCCN projected v2 from H:Harmony + I:Information, aligned with H³ direct+Cognitive polarity horizons.
...
| Arousal | S⁰.L5.loudness[35] + S⁰.L5.rms[47] + HC⁰ affect | R³.loudness[8] + R³.rms_energy[9] |
| Chills peak | S⁰.L5.loudness + HC⁰ peak | R³.loudness |
| Network state | S⁰.X_L5L6[208:216] + HC⁰ scene | R³.x_l0l5[25:33] |
