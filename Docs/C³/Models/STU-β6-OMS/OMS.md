...
### 2.2 Information Flow Architecture (EAR → BRAIN → OMS)
...
OMS requires H³ features at three horizons: H6 (200ms), H11 (500ms), H16 (1000ms).
...
OMS projected v2 features from G:Rhythm and K:Modulation, aligned with corresponding H³ horizons.
...
| 116 | mod_2Hz | K | 6 | M0 (value) | L0 | 2Hz modulation at beat scale |
| 116 | mod_2Hz | K | 16 | M0 (value) | L0 | 2Hz modulation over bar |
...
Orchestral Synchronization:
 ...
 Network Functions:
 Predictive(t) = σ(w₁ · beat_induction · onset_signal + ...)
 Sensorimotor(t) = σ(w₂ · meter_extraction · coupling + ...)
 Interpersonal(t) = σ(w₃ · motor_entrainment · coherence + ...)
...
│ Three-way coupling across all beat-entrainment sub-sections (r = 0.70 auditory-motor) │
│ │
...
| Predictive timing | S⁰.X_L0L1[128:136] × HC⁰.PTM | R³.x_l0l5[25:33] |
| Sensorimotor coupling | S⁰.X_L1L5[152:160] × HC⁰.NPL | R³.x_l4l5[33:41] |
| Interpersonal sync | S⁰.L3.coherence[14] × HC⁰.GRV | R³.x_l5l7[41:49] |
| Orchestral balance | S⁰.L7.crossband[80:88] | R³.x_l5l7[41:49] (perceptual x crossband) |
| Interval timing | HC⁰.ITM[216:244] | Absorbed into meter_extraction[10:20] |
