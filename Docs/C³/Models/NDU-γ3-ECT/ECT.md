...
### 2.1 Information Flow Architecture (EAR → BRAIN → ECT)
...
ECT requires H³ features for within-network efficiency measurement and for cross-network flexibility assessment. The demand reflects the multi-scale temporal integration needed for network architecture modeling.
...
Minor v2 expansion for ECT from I:Information.

| R³ Idx | Feature | Group | H | Morph | Law | Purpose |
|:------:|---------|:-----:|:-:|-------|:---:|---------|
| 90 | spectral_surprise | I | 3 | M0 (value) | L2 | Prediction error for flexibility measurement |
...
| Within-network | S⁰.L7.crossband[80:104] + HC⁰.BND | R³.x_l0l5[25:33] |
| Between-network | S⁰.X_L5L6[208:216] + HC⁰.SGM | R³.x_l5l6[41:49] |
| Adaptation | S⁰.L4.velocity_F[16] + HC⁰.TIH | R³.spectral_change[21] |
| Optimization | S⁰.L3.coherence[14] + HC⁰.EFC | R³.x_l4l5[33:41] |
