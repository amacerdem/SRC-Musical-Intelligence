...
### 2.2 Information Flow Architecture (EAR → BRAIN → SDNPS)
...
SDNPS requires H³ features at three horizons: H0 (25ms), H3 (100ms), H6 (200ms).
...
────┼─────────────────────────┼─────────┼──────────────────────────────────────
 ...
 │ │ │ phase-locking aggregation from pitch-processing H³.
 │ │ │ pitch_salience mean.
────┼─────────────────────────┼─────────┼──────────────────────────────────────
 5 │ harmonicity_proxy │ [0, 1] │ Harmonicity index from spectral
 │ │ │ structure. consonance_encoding
...
| Roughness signal | S⁰.roughness[30] + HC⁰.OSC | R³.roughness[0] |
| Harmonicity | S⁰.helmholtz_kang[32] + HC⁰.HRM | R³.helmholtz_kang[2] |
| NPS | S⁰.tonalness × HC⁰.NPL | R³.tonalness[14] |
