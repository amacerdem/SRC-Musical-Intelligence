...
### 2.1 Information Flow Architecture (EAR → BRAIN → SPMC)
...
SPMC requires H³ features for motor timing and for sequence planning. The demand reflects the hierarchical temporal integration from SMA planning (longer) to M1 execution (shorter).
...
SPMC projected v2 from G:Rhythm, aligned with corresponding H³ horizons.
...
idx │ Name │ Range │ Neuroscience Basis
────┼──────────────────────────┼────────┼────────────────────────────────────
 6 │ sma_activity │ [0, 1] │ temporal-context SMA planning activation level.
────┼──────────────────────────┼────────┼────────────────────────────────────
 7 │ m1_output │ [0, 1] │ beat-entrainment M1 execution output level.
...
| SMA encoding | S⁰.L4.τ_velocity_T[15] + HC⁰.PTM | R³.spectral_flux[10] |
| PMC selection | S⁰.L9.Γ_entropy_T[116] + HC⁰.NPL | R³.spectral_change[21] |
| M1 execution | S⁰.X_L0L4[128:136] + HC⁰.GRV | R³.x_l0l5[25:33] |
| Cerebellar timing | S⁰.Γ_var[105] + HC⁰.ITM | H³ stability tuples |
