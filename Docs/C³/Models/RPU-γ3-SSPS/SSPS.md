...
### 2.1 Information Flow Architecture (EAR → BRAIN → SSPS)
...
SSPS projected v2 from H:Harmony + I:Information, aligned with H³ direct+Cognitive polarity horizons.
...
| Saddle surface | S⁰.X_L4L5[192:200] + HC⁰ peak | R³.x_l4l5[33:41] |
| Context | S⁰.X_L0L1[128:136] + HC⁰ cognitive | R³.x_l0l5[25] |
