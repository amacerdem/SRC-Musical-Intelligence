...
### 2.1 Information Flow Architecture (EAR → BRAIN → IACM)
...
IACM requires H³ features for oscillatory spectral encoding and for attentional gating and precision estimation. The demand reflects multi-scale integration for spectral complexity detection.
...
IACM is projected to consume R³ v2 features from F[49:65], aligned with corresponding H³ horizons.
...
idx │ Name │ Range │ Neuroscience Basis
────┼──────────────────────────┼────────┼────────────────────────────────────
 6 │ p3a_capture │ [0, 1] │ auditory-scene attention-gated P3a response.
────┼──────────────────────────┼────────┼────────────────────────────────────
 7 │ spectral_encoding │ [0, 1] │ beat-entrainment oscillatory spectral encoding.
...
| Inharmonicity | S⁰.L5.inharmonicity[32] + HC⁰.OSC | R³.tonalness[14] + R³.spectral_flatness[16] + beat-entrainment H³ |
| Entropy | S⁰.L9.entropy_F[117] + HC⁰.ATT | R³ spectral features |
| Object segregation | S⁰.X_L0L1[128:136] + HC⁰.OSC | R³.x_l0l5[25:33] |
