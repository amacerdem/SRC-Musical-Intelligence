...
### 2.2 Information Flow Architecture (EAR → BRAIN → MDNS)
...
MDNS requires H³ features at four horizons spanning H6 and (H8, H11, H14).
...
MDNS projected v2 features from F:Pitch and G:Rhythm, aligned with corresponding H³ horizons.
...
────┼───────────────────┼────────┼────────────────────────────────────────────
 ...
 │ │ │ short_context × beat-entrainment phase-locking.
────┼───────────────────┼────────┼────────────────────────────────────────────
...
11 │ imagery_generatn │ [0, 1] │ Internal representation activation.
 ...
 │ │ │ long_context template matching.
...
class MDNS(BaseModel):
 ...
 # Phrase context (H14 = 700ms, temporal-context horizon)
...
| Pitch tracking | S⁰.L0.frequency[1] + HC⁰.TIH | R³.tonalness[14] + R³.autocorrelation[17] |
| Note onset | S⁰.L5.spectral_flux[45] + HC⁰.NPL | R³.spectral_flux[10] + R³.onset_strength[11] |
...
| Imagery | HC⁰.EFC (efference copy) | medium_context |
