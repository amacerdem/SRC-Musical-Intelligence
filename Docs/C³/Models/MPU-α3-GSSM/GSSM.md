...
### 2.1 Information Flow Architecture (EAR → BRAIN → GSSM)
...
GSSM requires H³ features for gait phase-locked tracking and for stride interval memory. The demand reflects the multi-scale temporal integration required for gait-synchronized stimulation.
...
GSSM projected v2 from G:Rhythm and K:Modulation, aligned with corresponding H³ horizons.
...
idx │ Name │ Range │ Neuroscience Basis
────┼──────────────────────────┼────────┼────────────────────────────────────
 7 │ phase_lock_strength │ [0, 1] │ beat-entrainment gait-phase lock activity.
────┼──────────────────────────┼────────┼────────────────────────────────────
...
| Phase signal | S⁰.L4.τ_T[15] + HC⁰.NPL | R³.spectral_flux[10] |
| CV signal | S⁰.L9.Γ_var[105] + HC⁰.PTM | R³.x_l0l5[25:33] |
| Balance | S⁰.X_L0L4[128:136] + HC⁰.GRV | R³.x_l4l5[33:41] |
