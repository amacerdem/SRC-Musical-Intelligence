...
### 2.2 Information Flow Architecture (EAR → BRAIN → STAI)
...
R³[4] pleasantness ──────────────┤ Math: weighted product with pitch processing
...
STAI requires H³ features at both horizons (H0, H3, H6) for consonance tracking and Timbre processing horizons (H2, H5, H8) for timbre/temporal envelope tracking. This dual-scale demand reflects the spectral-temporal interaction at the core of the model.
...
STAI is projected to consume R³ v2 features from F[49:65] and H[75:87], aligned with corresponding H³ horizons.
...
| Spectral signal | S⁰.L5.roughness[30] + HC⁰.HRM | R³.roughness[0] |
| Temporal signal | S⁰.L5.temporal_centroid[49] + HC⁰.SGM | R³.spectral_change[21] |
| Aesthetic binding | S⁰.X_L4L5[192:200] + HC⁰.BND | R³.x_l4l5[33:41] + H³ binding tuples |
| Connectivity | S⁰.X_L5L6[208:216] + HC⁰ affect | f03 * 0.52 (empirical d) |
