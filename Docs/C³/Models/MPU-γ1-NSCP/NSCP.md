...
### 2.1 Information Flow Architecture (EAR → BRAIN → NSCP)
...
NSCP requires H³ features at multi-scale Beat entrainment horizons for oscillatory tracking (ISC proxy) and for consistent temporal binding. The demand reflects the population-level synchrony computation requiring broad temporal integration.
...
idx │ Name │ Range │ Neuroscience Basis
────┼──────────────────────────┼────────┼────────────────────────────────────
 6 │ coherence_level │ [0, 1] │ beat-entrainment cross-layer coherence level.
────┼──────────────────────────┼────────┼────────────────────────────────────
 7 │ groove_response │ [0, 1] │ beat-entrainment groove/motor response level.
...
| Coherence signal | S⁰.L3.global_xi[14] + HC⁰.OSC | R³.stumpf[3] |
| Sync proxy | S⁰.X_L0L4[128:136] + HC⁰.OSC | R³.x_l0l5[25:33] |
| Catchiness | S⁰.L9.Γ_var[105] + HC⁰.GRV | R³.onset_strength[11] |
| Attention | S⁰.L5.Λ_loudness[35] + HC⁰.ATT | H³ entropy tuples |
