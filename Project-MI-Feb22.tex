...
\begin{center}
{\LARGE\bfseries Musical Intelligence: A Three-Layer Computational\\[4pt]
Architecture for Neuroscience-Informed Music Cognition}\\[14pt]
{\large A.~Macerdem\textsuperscript{1}}\\[6pt]
{\small\itshape \textsuperscript{1}Independent Researcher}\\[4pt]
{\small February 22, 2026}\\[10pt]
\rule{\textwidth}{0.5pt}
\end{center}
...
g_i^{(t)} &= \frac{\piobs_i}{\piobs_i + \pipred_i + \epsilon} \label{eq:gain} \\[4pt]
