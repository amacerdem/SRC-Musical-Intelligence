...
**Authors:** Thomas A. Deuel
**Year:** D:20
**Subject:** A novel musical instrument and biofeedback device was created using electroencephalogram (EEG) posterior dominant rhythm (PDR) or mu rhythm to control a synthesized piano, which we call the Encephalophone.
...
Media (DXARTS), University of Washington, Seattle, WA, USA, 3School of Music, University of Washington, Seattle, WA, USA, 4Department of Neurosurgery, University of Washington, Seattle, WA, USA
Edited by: Mikhail Lebedev, Duke University, USA
Reviewed by: Jaeseung Jeong, Korea Advanced Institute of Science
and Technology (KAIST), South Korea
Evgueni Blagovechtchenski, National Research University - Higher
School of Economics, Russia
*Correspondence: Thomas A. Deuel
tasdeuel@gmail.com
Received: 05 August 2016
Accepted: 11 April 2017
Published: 26 April 2017
Citation: Deuel TA, Pampin J, Sundstrom J
and Darvas F (2017)
The Encephalophone: A Novel
Musical Biofeedback Device
using Conscious Control of
Electroencephalogram (EEG). Front. Hum. Neurosci. 11:213.
doi: 10.3389/fnhum.2017.00213
A
novel
musical
...
generation (19.03% accuracy). Moreover, PDR control was signiﬁcantly more accurate
...
biofeedback device for patients suffering from motor deﬁcits (e.g., amyotrophic lateral
sclerosis (ALS), brainstem stroke, traumatic amputation). Keywords: biofeedback, electroencephalogram, music, brain-computer interface, rehabilitation
INTRODUCTION
Since early in the history of the use of electroencephalogram (EEG) for measurement of electrical
patterns of the human brain, efforts have been made to transform EEG electrical activity into sound. These efforts not only created diagnostic alternatives to purely visual feedback, but also opened up
new possibilities for artistic expression, and created possibilities for therapeutic biofeedback. The earliest example of converting EEG signal to sound appears in the literature
...
by Berger (1929), monitored their own EEG with sound (Adrian and Matthews, 1934). Frontiers in Human Neuroscience | www.frontiersin.org

April 2017 | Volume 11 | Article 213

Deuel et al. Encephalophone: A Novel Musical BCI
...
(Rosenboom, 1975). Following in Lucier’s pathway 5 years later, David Rosenboom
...
and auditory performance (Rosenboom, 1975). More recently, Brouse et al. (2006), created EEG waveform spectral analysis in
multiple frequency bands to passively control sound and music,
in a project for the eNTERFACE summer workshop. Eduardo
Miranda
at
the
Interdisciplinary
Centre
for
Computer Music Research (ICCMR) at Plymouth University, UK was part of that summer workshop project, and has gone
...
subjectively positive emotions (Eaton et al., 2014). Similarly, Makeig et al. (2011) used EEG and non-EEG signal (scalp
muscle and eye movement) from one subject to drive the
use of subjective emotions to control a series of musical
intervals. Pham et al. (2005) used slow cortical potentials of EEG
...
a visual stimulus. Some of the devices described above which use conscious
control can be considered Brain Computer Interfaces (BCIs; Wolpaw and Wolpaw, 2012). BCI research has progressed
...
potential applications with patients with motor disabilities. Alpha frequency control using both PDR and mu rhythms
...
Washington (Seattle, WA, USA). Recruitment of Subjects
The
subjects
were
recruited
...
fliers
to
undergraduate and graduate students at a university setting. Inclusion criterion was healthy adults, and exclusion criteria was
age less than 25 or greater than 65. EEG Signal Collection
Figure
...
setup
(Figure
1). A Mitsar 201 EEG (Mitsar Co., Ltd., St. Petersburg, Russia;
...
(Electro-Cap
International
Inc., Eaton, OH, USA) were used to collect EEG signal utilizing the
International 10-20 system of electrode placement (American
Electroencephalographic Society, 1994) from 15 healthy human
volunteer subjects. Subjects were positioned in a relaxed, reclining position with
...
Deuel et al. Encephalophone: A Novel Musical BCI
FIGURE 1 | Experimental setup. Electroencephalogram (EEG) signal from subject wearing electrode cap is sent from Mitsar 201 EEG ampliﬁer to Computer
...
octave (C4 to C5). After the calibration period is used to calibrate the instrument
...
experiments. This free-running stream of values from 1 to 8 in Matlab
...
is received by Max/MSP music generation software (Cycling ’74, Walnut, CA, USA). The streaming values from 1 to 8 are
used to generate the 8 scale degree notes in the C major
musical scale with a synthesized piano tone (eight notes
from C4 to C5). Accuracy Experiments
...
from the Department of Biostatistics, University of Washington, Seattle, WA, USA. Statistical analysis of p-values was performed
...
(summary shown in Table 2). Subjects using PDR control had an average of 27.4 hits
(standard deviation = 11.9, standard error ± 3.2) in an average of
TABLE 1 | Subject demographics. Years musical
Subject #
Age
Gender
training
...
accuracies (average 57.1%). In order to assess for individual subject bias skewed
...
generate skewness towards the extremes (notes 1 and 8). There was a range of skew bias, with the most significant
...
chance (19.03%). We also looked at the correlation between PDR hits and
...
−0.11,
respectively)—with
increasing years of musical training. Frontiers in Human Neuroscience | www.frontiersin.org

April 2017 | Volume 11 | Article 213

Deuel et al. Encephalophone: A Novel Musical BCI
TABLE 2 | Individual subject results from accuracy experiments. Subject #
PDR hits
PDR trials
...
19.03
19.03
Number of hits, number of trials, and percent (%) accuracy with p values for both PDR control and mu control. DISCUSSION
...
accuracy. These studies demonstrate that the Encephalophone allows
...
significantly improve accuracy and facility with the instrument. The use of scalar musical tones—rather than non-musical sound
or visual biofeedback—may confer a training advantage: the
benefits of music for arousal motivation for both training
and therapeutics have been shown (Bergstrom et al., 2014). Third, the use of a musical feedback-based EEG device with
...
(A) Percent accuracy using PDR control (standard error ± 4.7). (B) Percent accuracy using mu control (standard error ± 3.0). Frontiers in Human Neuroscience | www.frontiersin.org
...
their injury. Previously, others have reported use of BCI to control
...
than 2). This device is being used as a novel improvisational
...
using conscious control of sound spatialization is being explored. Diagnostically, the Encephalophone might prove useful in
auditory monitoring of clinical EEG applications, such as
auditory seizure detection, as described by Loui et al. (2014). Therapeutically, we also plan on using the Encephalophone
...
design, analysis of data and drafting and editing the manuscript. JS contributed to all of this aspects of the work, particularly in
...
of the data, as well as drafting and editing the manuscript. FUNDING
This research received no outside funding. The authors received
no specific funding for this work. REFERENCES
...
mixed models. J. Am. Stat. Assoc. 88, 9–25. doi: 10.1080/01621459.1993. Brouse, A., Filatriau, J., Gaitanis, K., Lehembre, R., Macq, B., Miranda, E. R.,
...
International Computer Music Conference (Greece: University of Athens). Hinterberger, T., and Baier, G. (2005). Parametric orchestral sonification of EEG
...
Interaction - Volume Part II (Berlin, Heidelberg: Springer-Verlag), 487–496. Miranda, E. R., Magee, W. L., Wilson, J. J., Eaton, J., and Palaniappan, R. (2011). Brain-computer music interfacing (BCMI): from basic research to the real
...
ArtAbilitation (Porto, Portugal). Neuper, C., Müller-Putz, G. R., Scherer, R., and Pfurtscheller, G. (2006). Motor
imagery and EEG-based control of spelling devices and neuroprostheses. Prog. Brain Res. 159, 393–409. doi: 10.1016/s0079-6123(06)59025-9
...
Pfurtscheller, G., Neuper, C., Guger, C., Harkam, W., Ramoser, H., Schlögl, A., et al. (2000). Current trends in graz brain-computer interface
(BCI) research. IEEE Trans. Rehabil. Eng. 8, 216–219. doi: 10.1109/86. Pham, M., Hinterberger, T., Neumann, N., Kübler, A., Hofmayer, N., Grether, A.,
...
based
brain-computer
interfacing. Med. Biol. Eng. Comput.
37,
93–98.
doi:
10.1007/bf025
...
and the Arts: Results of Early Experiments, ed. D. Rosenboom (Vancouver, BC: Aesthetic Research Centre of Canada), 60–61. Sellers, E. W., Rayn, D. B., and Hauser, C. K. (2014). Noninvasive brain-computer
...
and Practice. Oxford, New York, NY: Oxford University Press. Yuan, H., and He, B. (2014). Brain-computer interfaces using sensorimotor
...
be construed as a potential conflict of interest. Copyright © 2017 Deuel, Pampin, Sundstrom and Darvas. This is an open-access
...
terms. Frontiers in Human Neuroscience | www.frontiersin.org
