"""Boundary condition tests — F5 beliefs handle edge-case audio gracefully.
...
Validates:
  ...
  - All 15 F5 beliefs remain in [0, 1]
"""
...
class TestBoundaryConditions:
    ...
    def test_silence(self, runner):
        """Pure silence produces valid output for all F5 beliefs."""
        results = runner.run(silence(2.0), ALL_F5)
    ...
    def test_dc_offset(self, runner):
        ...
        results = runner.run(audio, ALL_F5)
