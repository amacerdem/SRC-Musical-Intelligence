"""Boundary condition tests — F6 beliefs handle edge-case audio gracefully.
...
Validates:
  ...
  - All 16 F6 beliefs remain in [0, 1]
"""
...
ALL_F6 = [
    # SRP (11)
    "wanting", "liking", "pleasure", "prediction_error", "tension",
...
def _check_all_valid(results: dict, label: str) -> None:
    """Assert no NaN, no Inf, all in [0, 1] for all returned beliefs."""
