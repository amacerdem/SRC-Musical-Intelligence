"""Boundary condition tests — F4 beliefs handle edge-case audio gracefully.
...
Validates:
  ...
  - All 13 F4 beliefs remain in [0, 1]
"""
...
class TestBoundaryConditions:
    ...
    def test_silence(self, runner):
        """Pure silence produces valid output for all F4 beliefs."""
        results = runner.run(silence(2.0), ALL_F4)
    ...
    def test_dc_offset(self, runner):
        ...
        results = runner.run(audio, ALL_F4)
