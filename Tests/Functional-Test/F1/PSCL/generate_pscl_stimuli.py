"""Generate PSCL test stimuli — 18 MIDI audio files.

Targets PSCL's theoretical predictions (Patterson 2002, Penagos 2004,
Bidelman 2009, Tabas 2019) with:
...
Tests/Functional-Test/F1/PSCL/stimuli/
"""
