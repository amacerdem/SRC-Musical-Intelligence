"""
η (Eta) — Vocabulary (12D)

Level 7: 64-gradation quantization of polarity axes into human-readable
semantic terms.

Each dimension corresponds to one ζ polarity axis, quantized to one of
...
64-Gradation System:
  - 8 intensity bands × 8 gradations per band = 64 levels
...
class EtaGroup(BaseSemanticGroup):
    ...
    def compute(
        ...
        **kwargs,
        ...
        """Compute η group — 64-gradation vocabulary quantization.

        Quantizes ζ polarity axes [-1,+1] → 64 discrete levels → [0,1].
        """
    ...
    def get_terms(self, zeta_output: Tensor) -> List[List[Dict[str, str]]]:
