...
class PPC(BaseMechanism):
    """Pitch Processing Chain.

    Processes pitch-related spectral features across three temporal horizons
    (H0, H3, H6). Primary R3 domain is Consonance [0:7], secondary is
    Timbre [12:21].
    """
    ...
    _SECONDARY_R3 = tuple(range(12, 21))   # C domain: Timbre
