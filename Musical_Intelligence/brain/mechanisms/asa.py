...
class ASA(BaseMechanism):
    ...
    Processes auditory scene analysis features across three temporal horizons
    (H3, H6, H9). Primary R3 domain is Energy [7:12], secondary is
    Consonance [0:7], tertiary is Change [21:25].
    """
