...
class C0P(BaseMechanism):
    ...
    Processes cognitive projection features across three temporal horizons
    (H18, H19, H20). Primary R3 domain is Consonance [0:7], secondary is
    Energy [7:12], tertiary is Interactions [25:49].

    Note: The class name uses a zero (0), not the letter O.
    """
