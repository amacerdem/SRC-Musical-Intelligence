...
Dependent (Phase 4) — receives cross-unit inputs.
10 models, 120D total output, circuit: mesolimbic, d = 0.83.
"""
...
class ARUUnit(BaseCognitiveUnit):
    """Affective Resonance Unit (ARU).

    Circuit: mesolimbic | d = 0.83 | 10 models | 120D
    """
